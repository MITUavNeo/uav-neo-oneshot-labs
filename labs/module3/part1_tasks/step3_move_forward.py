...
Your task:
    ...
    3. Get the contour's centroid: cx, cy = rc_utils.get_contour_center(best)
       Get the area:              area  = rc_utils.get_contour_area(best)
...
def update(drone):
    ...
    # Step 3: cx, cy = rc_utils.get_contour_center(best)
