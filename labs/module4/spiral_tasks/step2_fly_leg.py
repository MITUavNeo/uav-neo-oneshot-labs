...
def update(drone):
    ...
    #         contours = rc_utils.find_contours(image, TARGET_LOWER, TARGET_UPPER)
    #         best = rc_utils.get_largest_contour(contours, MIN_AREA)
    # Step 3: if best is not None:
    #             found_contour = best
    #             found_cx, found_cy = rc_utils.get_contour_center(best)
    #             area = rc_utils.get_contour_area(best)
