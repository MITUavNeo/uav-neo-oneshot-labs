"""Module 5 Part 4 — Right-Hand Rule Maze Solver"""
...
def update_slow():
    ...
    r = rc_utils.get_lidar_average_distance(s, 270, 15)
    print(f"Front={f:.2f}m  Right={r:.2f}m | Alt={drone.physics.get_altitude():.2f}m")
